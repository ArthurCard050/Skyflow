...
export const INITIAL_BATCHES: Batch[] = [
  ...
  { id: 'b4', name: 'Calendário Abril 2026', clientId: '4', createdAt: '2026-03-29' },
];
...
export const INITIAL_POSTS: Post[] = [
  {
    ...
    clientId: '1',
    batchId: 'b1',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/tech1/800/800', type: "image", format: "portrait" }],
  ...
  },
  {
    ...
    clientId: '1',
    batchId: 'b1',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/tech2/800/800', type: "image", format: "portrait" }],
  ...
  },
  {
    ...
    clientId: '2',
    batchId: 'b3',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/green1/800/800', type: "image", format: "portrait" }],
  ...
  },
  {
    ...
    clientId: '2',
    batchId: 'b3',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/green2/800/800', type: "image", format: "portrait" }],
  ...
  },
  {
    id: '5',
    clientId: '3',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/urban1/800/800', type: "image", format: "portrait" }],
  ...
  },
  {
    ...
    clientId: '1',
    batchId: 'b2',
    media: [{ id: "m_" + Math.random().toString(36).substr(2, 9), url: 'https://picsum.photos/seed/tech3/800/800', type: "image", format: "portrait" }],
