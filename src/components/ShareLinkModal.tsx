              ...
              <div className="p-6 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none appearance-none"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      onClick={handleCopy}
                      className="bg-white border border-gray-200 hover:border-sky-300 hover:text-sky-600 text-gray-600 px-4 rounded-xl transition-all flex items-center justify-center shadow-sm"
                      title="Copiar Link"
                    >
